...
<div class="col-md-9 bor">
	...
	<section class="box-main1">
		...
		<div class="showitem">
			...
			<div class="col-md-3  item-product bor">
				<a href="">
					<img src="<?php echo baseUrl(); ?>public/frontend/images/anh2.png" class="" width="100%" height="180">
				</a>
				<div class="info-item">
					<a href="">Lorem ipsum dolor sit amet</a>
					<p><strike class="sale">19.000.000 đ</strike> <b class="price">11.000.000 đ</b></p>
			...
			<div class="col-md-3  item-product bor">
				<a href="">
					<img src="<?php echo baseUrl(); ?>public/frontend/images/anh4.png" class="" width="100%" height="180">
				</a>
				<div class="info-item">
					<a href="">Lorem ipsum dolor sit amet</a>
					<p><strike class="sale">19.000.000 đ</strike> <b class="price">11.000.000 đ</b></p>
			...
			<div class="col-md-3  item-product bor">
				<a href="">
					<img src="<?php echo baseUrl(); ?>public/frontend/images/anh3.png" class="" width="100%" height="180">
				</a>
				<div class="info-item">
					<a href="">Lorem ipsum dolor sit amet</a>
					<p><strike class="sale">19.000.000 đ</strike> <b class="price">11.000.000 đ</b></p>
